...
export const About = () => {
  ...
  return (
    <section id="about" className="w-full max-w-6xl mx-auto px-1 sm:px-6 py-20 gap-10 bg-base-100 min-h-screen">
      <h1 className='text-6xl sm:text-8xl text-center mb-4 text-primary uppercase'>{t('about-title')}</h1>
          ...
          <GenericGridService delay={0.3} >
            <div className="card">
              <div className="card-body">
                <div className="card-title text-3xl sm:text-5xl">
                  My name is Palm
                </div>
                <MagicCard className='rounded-box border-2 border-base-content/10'>
                  <div className="card">
                    <div className="card-body text-lg sm:text-2xl">
            ...
            <div className="card-body flex flex-col items-center justify-center">
                  <h1 className="text-3xl sm:text-5xl w-full mb-6">Skills</h1>
        ...
        <div className="flex-1 flex gap-4 flex-wrap">
          {myData.working.map((work , index) => (
            ...
            <div className="card z-10 group min-h-60">
              <div className="card-body">
                <div className=" card-title text-xl sm:text-3xl">
                  <h1>{work.title}</h1>
                </div>
