...
var Outlet = React8.memo(function OutletImpl() {
  ...
  if (matchId === rootRouteId) {
    return (0, import_jsx_runtime9.jsx)(React8.Suspense, { fallback: pendingElement, children: nextMatch });
  }
  return nextMatch;
});
...
function lazyRouteComponent(importer, exportName, ssr) {
  ...
  const lazyComp = function Lazy(props) {
    ...
    if ((ssr == null ? void 0 : ssr()) === false) {
      return (0, import_jsx_runtime10.jsx)(ClientOnly, { fallback: (0, import_jsx_runtime10.jsx)(Outlet, {}), children: React9.createElement(comp, props) });
    }
...
function createLink(Comp) {
  return React13.forwardRef(function CreatedLink(props, ref) {
    return (0, import_jsx_runtime12.jsx)(Link, { ...props, _asChild: Comp, ref });
  });
}
...
function HeadContent() {
  const tags = useTags();
  return tags.map((tag) => (0, import_react3.createElement)(Asset, { ...tag, key: `tsr-meta-${JSON.stringify(tag)}` }));
}
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2PLTM2F6.js.map
